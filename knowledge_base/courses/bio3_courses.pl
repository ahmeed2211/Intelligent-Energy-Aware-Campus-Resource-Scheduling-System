...
course([biostatistique, pharmacologire], [1], bio3, lab).
course(bio3_fr, [1], bio3, projector).
course(bioterchnologie_env, [1], bio3, projector).
course(biotechnologie_molecuaires, [1], bio3, projector).
course([genie_genitique, immunologie_tech_immunologique], [1], bio3, lab).
course([technologie_microbienne, genie_biocatalyse], [1], bio3, lab).
course(bio3_eng, [1], bio3, projector).
course([genie_biocatalyse, immunologie_tech_immunologique], [1], bio3, lab).
course(biotechnologie_molecuaires, [1], bio3, lab).
