...
instructor_available(db, t31).
instructor_available(db, t32).
instructor_available(db, t33).
instructor_available(db, t34).
instructor_available(db, t35).

% Group 4: available Thursday only
instructor_available(gl3_fr, t41).
instructor_available(gl3_fr, t42).
instructor_available(gl3_fr, t43).
instructor_available(gl3_fr, t44).
instructor_available(gl3_fr, t45).

instructor_available(gl3_eng, t41).
instructor_available(gl3_eng, t42).
instructor_available(gl3_eng, t43).
instructor_available(gl3_eng, t44).
instructor_available(gl3_eng, t45).
...
instructor_available(web, t62).
instructor_available(web, t63).

instructor_available(concept, t61).
instructor_available(concept, t62).
instructor_available(concept, t63).